...
import { isArrayLengthGreaterThanZero } from "@/lib/utils";
...
export const MOCK_CAMPAIGNS: TCampaign[] = [
  ...
  },
  {
    ...
    description:
      "Menyediakan tempat tinggal sementara bagi pasien kanker dan keluarga dari luar kota.",
  ...
  },
  {
    ...
    description:
      "Program pelatihan penggunaan smartphone dan internet untuk para lansia di Surakarta.",
  ...
  },
  {
    ...
    description:
      "Pembangunan sumur bor untuk mengatasi kekeringan di desa terpencil Nusa Tenggara Timur.",
...
export default function CampaignsListPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-12rem)] container mx-auto px-4 py-8">
      ...
      {isArrayLengthGreaterThanZero(data) ? (
          ...
          {data?.map((campaign) => (
            <CampaignCard
              ...
              campaign={{
                ...
                // donors: campaign.donors, // Not directly available from current SC type
                daysLeft: campaign.timeRemaining,
                category: campaign.metadata?.category || "Uncategorized",
                campaigner: {
                  name: campaign.metadata.creatorName,
